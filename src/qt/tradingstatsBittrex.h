#ifndef TRADINGSTATSBITTREX_H
#define TRADINGSTATSBITTREX_H
...
extern double _dScPriceLastBittrex;
extern double _dBtcPriceCurrentBittrex;
extern double _dBtcPriceLastBittrex;
...
class TradingStatsBittrex : public QWidget
{
    Q_OBJECT

public:
    explicit TradingStatsBittrex(QWidget* parent = 0);
    ~TradingStatsBittrex();
...
private slots:
    void on_btnConvertEuropecoin_clicked();
    void on_btnUpdateMarketData_clicked();

private:
    QNetworkAccessManager m_nam;
    Ui::TradingStatsBittrex* ui;
    ClientModel* model;
};
