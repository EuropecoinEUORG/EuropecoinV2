...
void TradingStatsBittrex::on_btnConvertEuropecoin_clicked() {
    double EuropecoinQty = ui->txtConvertEuropecoinQty->text().toDouble();
    double totalBtc = _bittrexMarketSummary->getLastCurrent(double()) * EuropecoinQty;
...
{
    QDesktopServices::openUrl(QUrl("https://www.bittrex.com/Market/Index?MarketName=BTC-ERC"));
}
