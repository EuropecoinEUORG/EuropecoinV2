    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a EuropeCoin address (e.g. Eav4Dpy6SDWVTWnBjVzccFzF91qwFJcGun)"));
#endif
    ...
    connect(ui->checkBoxCoinControlChange, SIGNAL(stateChanged(iescapent)), this, SLOT(coinControlChangeChecked(int)));
