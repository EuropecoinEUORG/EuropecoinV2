...
//Bleutrade API
const QString apiBleutradeMarketSummary = "https://bleutrade.com/api/v2/public/getmarketsummary?market=ERC_BTC";
const QString apiBleutradeTrades = "https://bleutrade.com/api/v2/public/getmarkethistory?market=ERC_BTC&count=100";
const QString apiBleutradeOrders = "https://bleutrade.com/api/v2/public/getorderbook?market=ERC_BTC&type=ALL&depth=50";
...
void TradingStatsBleutrade::on_btnConvertEuropecoin_clicked() {
    double EuropecoinQty = ui->txtConvertEuropecoinQty->text().toDouble();
    double totalBtc = _bleutradeMarketSummary->getLastCurrent(double()) * EuropecoinQty;
    double totalUsd = totalBtc * _dBtcPriceCurrentBleutrade;

    ui->lblConvertEuropecoinResults->setText("$  " + QString::number(totalUsd, 'f', 2) +
...
{
    QDesktopServices::openUrl(QUrl("https://bleutrade.com/exchange/ERC/BTC"));
}
