    ...
    ui(new Ui::TradingDialogBittrex)
{
    ...
    CreateOrderBookTables(*ui->BidsTable,QStringList() << "TOTAL(BTC)"<< "ERC(SIZE)" << "BID(BTC)");
    CreateOrderBookTables(*ui->AsksTable,QStringList() << "ASK(BTC)"  << "ERC(SIZE)" << "TOTAL(BTC)");
    /*OrderBook Table Init*/
    ...
    ui->MarketHistoryTable->setHorizontalHeaderLabels(QStringList()<<"DATE"<<"BUY/SELL"<<"BID/ASK"<<"TOTAL UNITS(ERC)"<<"TOTAL COST(BTC");
...
QString TradingDialogBittrex::GetMarketSummary(){
     ...
     QString Response = sendRequest("https://bittrex.com/api/v1.1/public/GetMarketSummary?market=BTC-ERC");
     return Response;
}

QString TradingDialogBittrex::GetOrderBook(){

      QString  Response = sendRequest("https://bittrex.com/api/v1.1/public/getorderbook?market=BTC-ERC&type=both&depth=50");
      return Response;
}

QString TradingDialogBittrex::GetMarketHistory(){
      QString Response = sendRequest("https://bittrex.com/api/v1.1/public/getmarkethistory?market=BTC-ERC&count=100");
      return Response;
}
...
QString TradingDialogBittrex::BuyERC(QString OrderType, double Quantity, double Rate){
    ...
    QString URL = "https://bittrex.com/api/v1.1/market/";
            ...
            URL += "?apikey=";
            URL += this->ApiKey;
            URL += "&nonce=12345434&market=BTC-ERC&quantity=";
...
QString TradingDialogBittrex::GetOpenOrders(){
    QString URL = "https://bittrex.com/api/v1.1/market/getopenorders?apikey=";
            URL += this->ApiKey;
            URL += "&nonce=12345434&market=BTC-ERC";
...
QString TradingDialogBittrex::GetDepositAddress(){
    ...
    QString URL = "https://bittrex.com/api/v1.1/account/getdepositaddress?apikey=";
            URL += this->ApiKey;
            URL += "&nonce=12345434&currency=ERC";
...
QString TradingDialogBittrex::GetAccountHistory(){
    ...
    QString URL = "https://bittrex.com/api/v1.1/account/getorderhistory?apikey=";
            URL += this->ApiKey;
            URL += "&nonce=12345434&market=BTC-ERC&count=10";
...
int TradingDialogBittrex::SetExchangeInfoTextLabels(){
    ...
    ui->volumet->setText("<b>ERC Volume:</b> <span style='font-weight:bold; font-size:12px; color:black;'>" + str.number(obj["Volume"].toDouble(),'i',8) + "</span> ERC");
...
void TradingDialogBittrex::ParseAndPopulateOrderBookTables(QString OrderBook){
    ...
    foreach (const QJsonValue & value, BuyArray)
    {
        ...
        ui->ERCSupply->setText("<b>Supply:</b> <span style='font-weight:bold; font-size:12px; color:black'>" + str.number(ERCSupply,'i',8) + "</span><b> ERC</b>");
        ...
        ui->ERCDemand->setText("<b>Demand:</b> <span style='font-weight:bold; font-size:12px; color:black'>" + str.number(ERCDemand,'i',8) + "</span><b> ERC</b>");
    ...
    switch (index){
                ...
                case 1: //sell tab active
                                   ...
                                   if(Response.size() > 0 && Response != "Error"){
                                       ...
                                       QString balance = GetBalance("ERC");
                                       QString str;
                                       QJsonObject ResultObject =  GetResultObjectFromJSONObject(balance);
                ...
                case 6://show balance tab
                       Response = GetBalance("BTC");
                         ...
                         Response = GetBalance("ERC");

                       if(Response.size() > 0 && Response != "Error"){
                         DisplayBalance(*ui->ERCBalanceLabel,*ui->ERCAvailableLabel,*ui->ERCPendingLabel, QString::fromUtf8("ERC"),Response);
                        }
                break;
...
{
    //calculate amount of BTC that can be gained from selling ERC available balance
    QString responseA = GetBalance("ERC");
    QString str;
